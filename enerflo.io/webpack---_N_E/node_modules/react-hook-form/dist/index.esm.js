...
function useFormState(props) {
    ...
    const {
        control = methods.control, disabled, name
    } = props || {};
...
const useFieldArray = (props) => {
    const methods = useFormContext();
    const {
        control = methods.control, name, keyName = 'id', shouldUnregister,
    } = props;
        ...
        for (const key in values[index]) {
            if (Array.isArray(values[index][key])) {
                ...
                !isNullOrUndefined(defaultValues) &&
                    ...
                    (dirtyFields[index] = Object.assign(Object.assign({}, dirtyFields[index]), {
                        [key]: true
                    }));
            }
        }
    ...
    const handleChange = async (event) => {
        ...
        if (field) {
            ...
            if (shouldSkipValidation) {
                return (shouldRender &&
                    _subjects.state.next(Object.assign({
                        name
...
function useWatch(props) {
    const methods = useFormContext();
    const {
        control = methods.control, name, defaultValue, disabled,
    } = props || {};
    const _name = React.useRef(name);
    _name.current = name;
    useSubscribe({
