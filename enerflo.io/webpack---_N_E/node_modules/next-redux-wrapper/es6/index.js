                ...
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/ , callback(
                            ...
                            isApp ? __assign(__assign({}, context), {
                                ctx: __assign(__assign({}, context.ctx), {
                                    store: store
                                })
                ...
                return __generator(this, function(_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/ , __assign(__assign({}, settings), {
                                props: __assign(__assign({}, wrapperProps), props)
                            })];
                    }
                });
            });
        ...
        return function(context) {
            return __awaiter(void 0, void 0, void 0, function() {
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/ , getStaticProps(callback)(context)];
                        case 1:
                            return [2 /*return*/ , _a.sent()]; // just not to repeat myself
                    }
                });
            });
        };
    ...
    var withRedux = function(Component) {
        ...
        var Wrapper = function(_a, context) {
            ...
            var initialState = _a.initialState,
                ...
                props = __rest(_a, ["initialState", "initialProps"]);
        ...
        if ('getInitialProps' in Component)
            Wrapper.getInitialProps = function(context) {
                return __awaiter(void 0, void 0, void 0, function() {
                    var callback;
                    return __generator(this, function(_a) {
