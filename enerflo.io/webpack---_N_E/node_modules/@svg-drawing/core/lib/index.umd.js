! function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).SVGDCore = {})
}(this, (function(t) {
    "use strict";
    var e = function(t) {
            var e = {
        ...
        h = function(t, e) {
            ...
            return n.setAttributeNS(null, "version", "1.1"), n.setAttribute("xmlns", o), n.setAttribute("xmlns:xlink", "http://www.w3.org/1999/xlink"), Object.keys(t).sort().map((function(e) {
        ...
        u = function(t, e) {
            var n = document.createElementNS(o, t);
            return Object.keys(e).sort().map((function(t) {
                n.setAttribute(t, e[t])
            })), n
        },
        l = function(t) {
            var i = Object.entries(t).reduce((function(t, i, r) {
                var s, a = i[0],
                    o = i[1];
                return o ? e({}, t, ((s = {})[n(a)] = o, s)) : t
            }), {});
            return u("path", i)
        },
        c = function(t) {
        ...
        d = function() {
            ...
            return t.prototype.update = function(t) {
                this.el.replaceChild(c(t), this.el.childNodes[0])
            }, t
        }();
    var v = function(t, e) {
        if (null == t) return {};
    ...
    var f = function(t, e, n) {
        ...
        g = function() {
            ...
            return e.toString = function() {
                return this.type === w.CLOSE ? w.CLOSE : this.type + " " + this.value.map((function(t) {
                    return i(t)
                })).join(" ")
            }, e.scale = function(e) {
                ...
                get: function() {
                    ...
                    return 2 === t.length ? new m(t[0], t[1]) : void 0
                }
            }]), t
        }(),
        _ = function() {
        ...
        y = function() {
            function t(t) {
                var e = void 0 === t ? {} : t,
                    n = e.d,
                    i = v(e, ["d"]);
                this.attrs = i, this.commands = [], n && this.parseCommandString(n)
            }
            var n = t.prototype;
            return n.scale = function(t) {
                ...
                var e;
                Array.isArray(t) ? (e = this.commands).push.apply(e, t) : this.commands.push(t);
                return this
                ...
                this.commands = [];
                for (var e = null, n = [], i = t.split(" "), r = function(t) {
                        return Object.values(w).includes(t) ? t : null
                    }, s = 0; s < i.length; s += 1) {
                    var o = r(i[s]);
                    if (o) {
                        if (!e) {
                        ...
                        this.commands.push(new g(e, n)), e = o, n = []
                    } else {
                        if (a(+i[s])) return;
                        n.push(+i[s])
                    }
                }
                null !== e && this.commands.push(new g(e, n))
            }, n.parsePathElement = function(t) {
                for (var n = 0; n < t.attributes.length; n += 1) {
                    var i, s = t.attributes.item(n);
                    s && s.value && ("d" !== s.name ? this.attrs = e({}, this.attrs, ((i = {})[r(s.name)] = s.value, i)) : this.parseCommandString(s.value))
                }
                return this
            }, n.toJson = function() {
                return e({}, this.attrs, {
        ...
        E = function() {
            function t(t) {
                var e = t.width,
                    n = t.height,
                    i = t.background;
                this.paths = [], this.width = e, this.height = n, this.background = i
            }
            var e = t.prototype;
            return e.resize = function(t) {
                ...
                var e;
                Array.isArray(t) ? (e = this.paths).push.apply(e, t) : this.paths.push(t);
                return this
                ...
                t.querySelectorAll("path").forEach((function(t) {
                    var n = (new y).parsePathElement(t);
        ...
        b = function() {
            ...
            return e._controlPoint = function(t, e, n) {
                var i = new m(t.x, t.y),
                    r = new m(e.x, e.y),
                    s = new m(n.x, n.y).sub(i).toVector().scale(this.ratio).toPoint(),
                    a = r.add(s);
                return [a.x, a.y]
            }, e.bezierCurve = function(t, e, n, i) {
                var r = [].concat(this._controlPoint(t, e, n), this._controlPoint(i, n, e), [n.x, n.y]);
                return new g(w.CURVE, r)
            }, e.lineCommands = function(t) {
                return t.map((function(t, e) {
                    return new g(0 === e ? w.MOVE : w.LINE, [t.x, t.y])
                }))
            }, e.bezierCurveCommands = function(t) {
                var e = [];
                if (t.length < 3) return this.lineCommands(t);
                for (var n = 0; n < t.length; n += 1) 0 !== n ? e.push(this.bezierCurve(t[n - 2 < 0 ? 0 : n - 2], t[n - 1], t[n], n < t.length - 1 ? t[n + 1] : t[n])) : e.push(new g(w.MOVE, [t[n].x, t[n].y]));
                return e
            }, t
        }();
    ...
    function C(t, e, n) {
        ...
        var a = null,
            o = 0,
            h = function() {
                o = !1 === n.leading ? 0 : Date.now(), a = null, s = t.apply(i, r), a || (i = null, r = null)
            },
            u = function() {
        ...
        return function() {
            ...
            var c = e - (l - o);
            i = this;
            for (var d = arguments.length, v = new Array(d), p = 0; p < d; p++) v[p] = arguments[p];
            return r = v, c <= 0 || c > e ? (u(), o = l, s = t.apply(i, r), a || (i = null, r = null)) : a || !1 === n.trailing || (a = setTimeout(h, c)), s
        }
    }
    var L = function(t) {
            void 0 === t && (t = !0);
        ...
        x = function() {
            function t(t, e) {
                var n = e.end,
                    i = e.start,
                    r = e.move;
                this._el = t, this.end = n, this.start = i, this.move = r, this._clearEventList = [], this._listenerOption = L(!1);
                var s = t.getBoundingClientRect(),
                    a = s.left,
                    o = s.top;
                this._left = a, this._top = o, this._handleStart = this._handleStart.bind(this), this._handleMove = this._handleMove.bind(this), this._handleEnd = this._handleEnd.bind(this)
            }
            var e = t.prototype;
            return e.off = function() {
                ...
                (e = this._clearEventList).push.apply(e, h.concat(u, l, c))
        ...
        k = function(t) {
            for (var e = t.data, n = t.extension, i = t.filename, r = atob(e.replace(/^.*,/, "")), s = new Uint8Array(r.length), a = 0; a < r.length; a += 1) s[a] = r.charCodeAt(a);
            var o = i || Date.now() + "." + n,
                h = new Blob([s.buffer], {
                    type: O[n]
                });
            if (window.navigator.msSaveBlob) window.navigator.msSaveBlob(h, o);
            else if (window.URL && window.URL.createObjectURL) {
                var u = document.createElement("a");
                u.download = o, u.href = window.URL.createObjectURL(h), document.body.appendChild(u), u.click(), document.body.removeChild(u)
        ...
        z = function(t, n, i) {
            ...
            if ("svg" !== a) {
                ...
                c.addEventListener("load", (function() {
                    ...
                    t.setAttribute("width", String(h)), t.setAttribute("height", String(u));
                    var e = t.getContext("2d");
                    e && ((l || "jpg" === a) && (e.fillStyle = l || "#fff", e.fillRect(0, 0, h, u)), e.drawImage(c, 0, 0), i("png" === a ? {
        ...
        V = function() {
            function t(t, e) {
                var n = void 0 === e ? {} : e,
                    ...
                    h = n.fill,
                    u = n.background;
                this.el = t, this.penColor = null != i ? i : "#000", this.penWidth = null != r ? r : 1, this.curve = null == s || s, this.close = null != a && a, this.delay = null != o ? o : 0, this.fill = null != h ? h : "none";
                var l = t.getBoundingClientRect(),
                    c = l.width,
                    v = l.height;
                this._drawPath = null, this._drawPoints = [], this.svg = new E({
                    width: c,
                    height: v,
                    background: u
                }), this.renderer = new d(t, {
                    background: u
                }), this.convert = new b, this._resize = this._resize.bind(this), this.resizeHandler = new S(t, {
                    resize: this._resize
                }), this.drawStart = this.drawStart.bind(this), this.drawMove = this.drawMove.bind(this), this._drawMoveThrottle = C(this.drawMove, this.delay), this.drawEnd = this.drawEnd.bind(this), this.drawHandler = new x(t, {
            ...
            return e.update = function() {
                ...
                this.delay = t, this.drawHandler.move = C(this.drawMove, this.delay), this.drawHandler.on()
            }, e.on = function() {
                ...
                this._drawPath && (this.curve ? this._drawPath.commands = this.convert.bezierCurveCommands(this._drawPoints) : this._drawPath.commands = this.convert.lineCommands(this._drawPoints), this.close && this._drawPath.commands.push(new g(w.CLOSE)))
            }, e._addDrawPoint = function(t) {
                this._drawPoints.push(t), this._createCommand()
            }, e._createDrawPath = function() {
                return this._resize(this.el.getBoundingClientRect()), this._drawPoints = [], new y({
                ...
                var e = t.width,
                    n = t.height;
                s(this.svg.width, e) || (this.svg.resize({
                    width: e,
                    height: n
                }), this.update())
    ...
    t.COMMAND_TYPE = w, t.Command = g, t.Convert = b, t.DrawHandler = x, t.Path = y, t.Point = m, t.Renderer = d, t.ResizeHandler = S, t.Svg = E, t.SvgDrawing = V, t.Vector = _, t.camel2kebab = n, t.createSvgChildElement = u, t.createSvgElement = h, t.download = z, t.downloadBlob = k, t.getPassiveOptions = L, t.isAlmostSameNumber = s, t.isNaN = a, t.kebab2camel = r, t.mimeTypeMap = O, t.pathObjectToElement = l, t.roundUp = i, t.svg2base64 = A, t.svgObjectToElement = c, t.throttle = C, t.toBase64 = R, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}));