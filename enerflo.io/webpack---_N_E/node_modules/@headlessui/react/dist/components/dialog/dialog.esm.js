import {
    extends as _extends,
    objectWithoutPropertiesLoose as _objectWithoutPropertiesLoose,
    createForOfIteratorHelperLoose as _createForOfIteratorHelperLoose
...
import {
    match
} from '../../utils/match.esm.js';
import {
    forwardRefWithAs,
    render,
    Features as Features$1
} from '../../utils/render.esm.js';
import {
    useSyncRefs
} from '../../hooks/use-sync-refs.esm.js';
import {
    Keys
} from '../keyboard.esm.js';
import {
    isDisabledReactIssue7711
} from '../../utils/bugs.esm.js';
import {
    useServerHandoffComplete
} from '../../hooks/use-server-handoff-complete.esm.js';
import {
    useId
} from '../../hooks/use-id.esm.js';
import {
    useWindowEvent
} from '../../hooks/use-window-event.esm.js';
import {
    useFocusTrap,
    Features
} from '../../hooks/use-focus-trap.esm.js';
import {
    useInertOthers
} from '../../hooks/use-inert-others.esm.js';
import {
    ForcePortalRoot
} from '../../internal/portal-force-root.esm.js';
import {
    Portal
} from '../portal/portal.esm.js';
import {
    Description,
    useDescriptions
} from '../description/description.esm.js';
import {
    useOpenClosed,
    State
} from '../../internal/open-closed.esm.js';
import {
    StackProvider,
    StackMessage
} from '../../internal/stack-context.esm.js';
