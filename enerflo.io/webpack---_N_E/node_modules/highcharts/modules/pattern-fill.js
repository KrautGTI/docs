...
(function(b) {
    ...
    f(b, "Extensions/PatternFill.js", [b["Core/Animation/AnimationUtilities.js"], b["Core/Chart/Chart.js"], b["Core/Globals.js"],
        b["Core/DefaultOptions.js"], b["Core/Series/Point.js"], b["Core/Series/Series.js"], b["Core/Renderer/SVG/SVGRenderer.js"], b["Core/Utilities.js"]
    ], function(b, f, r, p, t, u, v, l) {
        function w(a, c) {
            a = JSON.stringify(a);
            var b = a.length || 0,
                e = 0,
        ...
        v.prototype.addPattern = function(a, c) {
            ...
            if (!(-1 < this.defIds.indexOf(g))) {
                ...
                k.id = g;
                a.path ? (h = l.isObject(a.path) ? a.path : {
                    d: a.path
                }, a.backgroundColor && m(a.backgroundColor), m = {
                    d: h.d
                }, this.styledMode || (m.stroke = h.stroke || n, m["stroke-width"] = q(h.strokeWidth, 2), m.fill = h.fill || "none"), h.transform && (m.transform = h.transform), this.createElement("path").attr(m).add(k), k.color = n) : a.image && (c ? this.image(a.image, 0, 0, e, d, function() {
                    this.animate({
                        opacity: q(a.opacity,
                            1)
                    }, b);
                    ...
                    opacity: 0
                }).add(k) : this.image(a.image, 0, 0, e, d).add(k));
        ...
        b(t, "afterInit", function() {
            ...
            a && a.pattern && ("string" ===
                typeof a.pattern.path && (a.pattern.path = {
                    d: a.pattern.path
                }), this.color = this.options.color = x(this.series.options.color, a))
        });
        b(v, "complexColor", function(a) {
            var c = a.args[0],
                b = a.args[1];
            a = a.args[2];
            var e = this.chartIndex || 0,
                d = c.pattern,
                f = "#343434";
            ...
            if (d.image || "string" === typeof d.path || d.path && d.path.d) {
                ...
                "defer" !== d._width && "defer" !== d._height ||
                    t.prototype.calculatePatternDimensions.call({
                        graphic: {
                            element: a
                        }
                    }, d);
