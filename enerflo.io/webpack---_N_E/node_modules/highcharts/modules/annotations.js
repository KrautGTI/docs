...
'use strict';
(function(a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/annotations", ["highcharts"], function(x) {
        a(x);
        a.Highcharts = x;
        return a
    ...
    function x(c, a, p, u) {
        c.hasOwnProperty(a) || (c[a] = u.apply(null, p))
    }
    a = a ? a._modules : {};
    x(a, "Extensions/Annotations/Mixins/EventEmitterMixin.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(c,
        a) {
        var f = a.addEvent,
            u = a.fireEvent,
            m = a.objectEach,
        ...
        return {
            addEvents: function() {
                var b = this,
                    d = function(d) {
                        f(d, c.isTouchDevice ? "touchstart" : "mousedown", function(d) {
                            b.onMouseDown(d)
                        }, {
                            passive: !1
                        })
                    };
                d(this.graphic.element);
                (b.labels || []).forEach(function(e) {
                    e.options.useHTML && e.graphic.text && d(e.graphic.text.element)
                });
                m(b.options.events, function(d, e) {
                    var c = function(c) {
                        "click" === e && b.cancelClick || d.call(b, b.chart.pointer.normalize(c), b.target)
                    };
                    if (-1 === (b.nonDOMEvents || []).indexOf(e)) b.graphic.on(e,
                        c);
                    else f(b, e, c, {
                        passive: !1
                    })
                ...
                if (b.options.draggable && (f(b, "drag", b.onDrag), !b.graphic.renderer.styledMode)) {
                    ...
                    (b.labels || []).forEach(function(d) {
                        d.options.useHTML && d.graphic.text && d.graphic.text.css(e)
                    })
                }
                b.isUpdating || u(b, "add")
            },
            ...
            onMouseDown: function(b) {
                ...
                if (2 !== b.button) {
                    ...
                    var g = b.chartY;
                    d.cancelClick = !1;
                    d.chart.hasDraggedAnnotation = !0;
                    d.removeDrag = f(c.doc, c.isTouchDevice ? "touchmove" : "mousemove", function(b) {
                        d.hasDragged = !0;
                        b = e.normalize(b);
                        b.prevChartX = t;
                        b.prevChartY = g;
                    ...
                    d.removeMouseUp = f(c.doc, c.isTouchDevice ? "touchend" : "mouseup", function(b) {
                        var e = n(d.target && d.target.annotation, d.target);
                        e &&
                            (e.cancelClick = d.hasDragged);
                        d.cancelClick = d.hasDragged;
                        d.hasDragged = !1;
                        d.chart.hasDraggedAnnotation = !1;
                        u(n(e, d), "afterUpdate");
                        d.onMouseUp(b)
                    }, c.isTouchDevice ? {
                        passive: !1
            ...
            onMouseUp: function(b) {
                var d = this.chart;
                b = this.target || this;
                var e = d.options.annotations;
                d = d.annotations.indexOf(b);
            ...
            onDrag: function(b) {
                if (this.chart.isInsidePlot(b.chartX - this.chart.plotLeft, b.chartY - this.chart.plotTop, {
                    ...
                    var d = this.mouseMoveToTranslation(b);
                    "x" ===
                    this.options.draggable && (d.y = 0);
            ...
            mouseMoveToRadians: function(b, d, e) {
                var c = b.prevChartY - e,
                    g = b.prevChartX - d;
                e = b.chartY - e;
                b = b.chartX - d;
                this.chart.inverted && (d = g, g = c, c = d, d = b, b = e, e = d);
                return Math.atan2(e, b) - Math.atan2(c, g)
            },
            mouseMoveToTranslation: function(b) {
                var d = b.chartX - b.prevChartX;
                b = b.chartY -
                    b.prevChartY;
            ...
            mouseMoveToScale: function(b, d, e) {
                d = (b.chartX - d || 1) / (b.prevChartX - d || 1);
                b = (b.chartY - e || 1) / (b.prevChartY - e || 1);
                this.chart.inverted && (e = b, b = d, d = e);
                return {
                    x: d,
                    y: b
                }
    ...
    x(a, "Extensions/Annotations/ControlPoint.js", [a["Core/Utilities.js"], a["Extensions/Annotations/Mixins/EventEmitterMixin.js"]], function(c, a) {
        ...
        return function() {
            function c(c, b, f,
                d) {
                this.addEvents = a.addEvents;
                this.graphic = void 0;
                this.mouseMoveToRadians = a.mouseMoveToRadians;
                this.mouseMoveToScale = a.mouseMoveToScale;
                this.mouseMoveToTranslation = a.mouseMoveToTranslation;
                this.onDrag = a.onDrag;
                this.onMouseDown = a.onMouseDown;
                this.onMouseUp = a.onMouseUp;
                this.removeDocEvents = a.removeDocEvents;
                this.nonDOMEvents = ["drag"];
                this.chart = c;
                this.target = b;
                this.options = f;
                this.index = u(f.index, d)
            }
            c.prototype.setVisibility = function(c) {
            ...
            c.prototype.render = function() {
                var c = this.chart,
                    b = this.options;
                this.graphic = c.renderer.symbol(b.symbol, 0, 0, b.width, b.height).add(c.controlPointsGroup).css(b.style);
                this.setVisibility(b.visible);
                this.addEvents()
            };
            ...
            c.prototype.update = function(c) {
                var b =
                    ...
                    a = this.target,
                    d = this.index;
                c = f(!0, this.options, c);
                this.destroy();
                this.constructor(b, a, c, d);
                this.render(b.controlPointsGroup);
                this.redraw()
            };
            return c
        }()
        ...
        return function() {
            function a(b, a, d) {
                ...
                this.series = {
                    visible: !0,
                    chart: b,
                    getPlotBox: c.prototype.getPlotBox
                };
                this.target = a || null;
                this.options = d;
                this.applyOptions(this.getOptions())
            }
            a.fromPoint = function(b) {
                return new a(b.series.chart, null, {
                    x: b.x,
                    y: b.y,
            ...
            a.pointToPixels = function(b, c) {
                var d = b.series,
                    e = d.chart,
                    a = b.plotX,
                    g = b.plotY;
                e.inverted && (b.mock ? (a = b.plotY, g = b.plotX) : (a = e.plotWidth - b.plotY, g = e.plotHeight - b.plotX));
                d && !c && (b = d.getPlotBox(), a += b.translateX, g += b.translateY);
                return {
                    x: a,
                    y: g
                }
            };
            a.pointToOptions = function(b) {
                return {
                    x: b.x,
                    y: b.y,
                    xAxis: b.series.xAxis,
            ...
            a.prototype.hasDynamicOptions = function() {
            ...
            a.prototype.applyOptions = function(b) {
                this.command = b.command;
                this.setAxis(b, "x");
                this.setAxis(b, "y");
                this.refresh()
            };
            a.prototype.setAxis = function(b, c) {
                c += "Axis";
                b = b[c];
                var d = this.series.chart;
                this.series[c] = b instanceof p ? b : f(b) ? d[c][b] || d.get(b) : null
            };
            a.prototype.toAnchor = function() {
            ...
            a.prototype.isInsidePlot = function() {
                var b = this.plotX,
                    c = this.plotY,
                    d = this.series.xAxis,
                    e = this.series.yAxis,
                ...
                d && (a.isInsidePlot = f(b) && 0 <= b && b <= d.len);
                e && (a.isInsidePlot = a.isInsidePlot && f(c) && 0 <= c && c <= e.len);
                m(this.series.chart, "afterIsInsidePlot", a);
            ...
            a.prototype.refresh = function() {
                ...
                c ? (this.x = d.x, this.plotX = c.toPixels(d.x, !0)) : (this.x = null, this.plotX = d.x);
                b ? (this.y = d.y, this.plotY = b.toPixels(d.y, !0)) : (this.y = null, this.plotY = d.y);
                this.isInside = this.isInsidePlot()
            };
            a.prototype.translate = function(b, c, d, e) {
                this.hasDynamicOptions() || (this.plotX += d, this.plotY += e, this.refreshOptions())
            };
            a.prototype.scale = function(b, c, d, e) {
            ...
            a.prototype.rotate =
                function(b, c, d) {
                    if (!this.hasDynamicOptions()) {
                        ...
                        a -= b;
                        g -= c;
                        this.plotX = a * e - g * d + b;
                        this.plotY = a * d + g * e + c;
                        this.refreshOptions()
                    }
                };
            a.prototype.refreshOptions = function() {
                var b = this.series,
                    c = b.xAxis;
                b = b.yAxis;
    ...
    x(a, "Extensions/Annotations/Mixins/ControllableMixin.js", [a["Extensions/Annotations/ControlPoint.js"],
        a["Extensions/Annotations/MockPoint.js"], a["Core/Tooltip.js"], a["Core/Utilities.js"]
    ], function(c, a, p, u) {
        var f = u.isObject,
            n = u.isString,
            b = u.merge,
        ...
        return {
            ...
            getPointsOptions: function() {
                var b = this.options;
                return b.points || b.point && F(b.point)
            },
            attrsFromOptions: function(b) {
                var c =
                    this.constructor.attrsMap,
                    d = {},
                    a, r = this.chart.styledMode;
                for (a in b) {
                    var q = c[a];
                    !q || r && -1 !== ["fill", "stroke", "stroke-width"].indexOf(q) || (d[q] = b[a])
                }
                return d
            },
            anchor: function(c) {
                var d = c.series.getPlotBox(),
                    a = c.series.chart,
                    g = c.mock ? c.toAnchor() : p.prototype.getAnchor.call({
                        chart: c.series.chart
                    }, c);
                g = {
                    x: g[0] + (this.options.x || 0),
                    y: g[1] + (this.options.y || 0),
                    height: g[2] || 0,
                    width: g[3] || 0
                };
                return {
                    relativePosition: g,
                    absolutePosition: b(g, {
                        x: g.x + (c.mock ? d.translateX : a.plotLeft),
                        y: g.y + (c.mock ? d.translateY : a.plotTop)
                    })
                }
            },
            point: function(b, c) {
                if (b && b.series) return b;
                c && null !== c.series || (f(b) ? c = new a(this.chart, this, b) : n(b) ? c = this.chart.get(b) || null : "function" === typeof b && (c = b.call(c, this), c = c.series ? c : new a(this.chart, this, b)));
                return c
            },
            linkPoints: function() {
            ...
            addControlPoints: function() {
                var d = this.options.controlPoints;
                (d || []).forEach(function(a, t) {
                    a =
                        b(this.options.controlPointOptions, a);
                    a.index || (a.index = t);
                    d[t] = a;
                    this.controlPoints.push(new c(this.chart, this, a))
                }, this)
            },
            ...
            transform: function(b, c, a, g, r) {
                if (this.chart.inverted) {
                    var d = c;
                    c = a;
                    a = d
                }
                this.points.forEach(function(d, e) {
                    this.transformPoint(b, c, a, g, r, e)
                }, this)
            },
            transformPoint: function(b, c, t, g, r,
                q) {
                var d = this.points[q];
                d.mock || (d = this.points[q] = a.fromPoint(d));
                d[b](c, t, g, r)
            },
            translate: function(b, c) {
                this.transform("translate", null, null, b, c)
            },
            translatePoint: function(b, c, a) {
                this.transformPoint("translate", null, null, b, c, a)
            },
            translateShape: function(b, c) {
                var a = this.annotation.chart,
                    d = this.annotation.userOptions,
                    e = a.annotations.indexOf(this.annotation);
                a = a.options.annotations[e];
                this.translatePoint(b, c, 0);
                a[this.collection][this.index].point = this.options.point;
                d[this.collection][this.index].point =
                    this.options.point
            },
            rotate: function(b, c, a) {
                this.transform("rotate", b, c, a)
            },
            scale: function(b, c, a, g) {
                this.transform("scale", b, c, a, g)
            },
            ...
            update: function(c) {
                ...
                c = b(!0, this.options, c);
                var d = this.graphic.parentGroup;
                this.destroy();
                this.constructor(a, c, this.index);
                this.render(d);
                this.redraw()
            }
        }
    ...
    x(a, "Extensions/Annotations/Mixins/MarkerMixin.js", [a["Core/Chart/Chart.js"], a["Core/Renderer/SVG/SVGRenderer.js"], a["Core/Utilities.js"]], function(c, a, p) {
        ...
        a.prototype.addMarker = function(c, a) {
            ...
            d.children = a.children && a.children.map(function(c) {
                return b(e,
                    c)
            });
            a = b(!0, {
        ...
        a = {
            markerEndSetter: f("marker-end"),
            markerStartSetter: f("marker-start"),
            setItemMarkers: function(c) {
                var a = c.options,
                    d = c.chart,
                    r = d.options.defs,
                    e = a.fill,
                    f = n(e) && "none" !== e ? e : a.stroke;
                ["markerStart", "markerEnd"].forEach(function(e) {
                    ...
                    if (g) {
                        for (q in r) {
                            var n = r[q];
                            if ((g === (n.attributes && n.attributes.id) || g === n.id) && "marker" === n.tagName) {
                                var h = n;
                                break
                            }
                        }
                        h && (g = c[e] = d.renderer.addMarker((a.id ||
                            F()) + "-" + g, b(h, {
                            color: f
                        })), c.attr(e, g.getAttribute("id")))
                    }
                })
            }
        };
        m(c, "afterGetContainer", function() {
            this.options.defs = b(d, this.options.defs || {})
        });
        return a
    });
    x(a, "Extensions/Annotations/Controllables/ControllablePath.js", [a["Extensions/Annotations/Mixins/ControllableMixin.js"], a["Core/Globals.js"], a["Extensions/Annotations/Mixins/MarkerMixin.js"], a["Core/Utilities.js"]], function(c, a, p, u) {
        var f = u.extend,
            n = "rgba(192,192,192," + (a.svg ? .0001 : .002) + ")";
        return function() {
            function b(b, a, e) {
                this.addControlPoints =
                    c.addControlPoints;
                ...
                this.setMarkers = p.setItemMarkers;
            ...
            b.prototype.toD = function() {
                ...
                var c = b.length,
                    a = c,
                    f = b[0],
                    g = a && this.anchor(f).absolutePosition,
                    r = 0,
                    q = [];
                if (g)
                    for (q.push(["M", g.x, g.y]); ++r < c && a;) f = b[r], a = f.command || "L", g = this.anchor(f).absolutePosition, "M" === a ? q.push([a, g.x, g.y]) : "L" === a ? q.push([a, g.x, g.y]) : "Z" === a && q.push([a]), a = f.series.visible;
                return a ? this.chart.renderer.crispLine(q,
                    this.graphic.strokeWidth()) : null
            };
            b.prototype.shouldBeDrawn = function() {
                return c.shouldBeDrawn.call(this) || !!this.options.d
            };
            b.prototype.render = function(b) {
                var a = this.options,
                    e = this.attrsFromOptions(a);
                ...
                c.render.call(this);
                f(this.graphic, {
                    markerStartSetter: p.markerStartSetter,
                    markerEndSetter: p.markerEndSetter
                });
        ...
        return function() {
            ...
            m.prototype.render =
                function(a) {
                    ...
                    this.graphic = this.annotation.chart.renderer.rect(0, -9E9, 0, 0).attr(b).add(a);
                    c.render.call(this)
                };
            m.prototype.redraw = function(a) {
                var b = this.anchor(this.points[0]).absolutePosition;
                if (b) this.graphic[a ? "animate" : "attr"]({
                    x: b.x,
                    y: b.y,
    ...
    x(a, "Extensions/Annotations/Controllables/ControllableCircle.js", [a["Extensions/Annotations/Mixins/ControllableMixin.js"], a["Extensions/Annotations/Controllables/ControllablePath.js"], a["Core/Utilities.js"]], function(c, a, p) {
        var f = p.merge;
        return function() {
            function m(a, b, f) {
                this.addControlPoints = c.addControlPoints;
            ...
            m.prototype.render = function(a) {
                var b = this.attrsFromOptions(this.options);
                this.graphic = this.annotation.chart.renderer.circle(0, -9E9, 0).attr(b).add(a);
                c.render.call(this)
            };
            m.prototype.redraw =
                function(a) {
            ...
            m.prototype.setRadius = function(c) {
                this.options.r = c
            };
            m.attrsMap = f(a.attrsMap, {
                r: "r"
    ...
    x(a, "Extensions/Annotations/Controllables/ControllableLabel.js", [a["Extensions/Annotations/Mixins/ControllableMixin.js"], a["Core/FormatUtilities.js"], a["Extensions/Annotations/MockPoint.js"],
        a["Core/Renderer/SVG/SVGRenderer.js"], a["Core/Tooltip.js"], a["Core/Utilities.js"]
    ], function(c, a, p, u, m, n) {
        var b = a.format;
        a = u.prototype.symbols;
        var f = n.extend,
            d = n.isNumber,
            e = n.pick;
        n = function() {
            ...
            a.alignedPosition = function(b, a) {
                var c = b.align,
                    d = b.verticalAlign,
                    e = (a.x || 0) + (b.x || 0),
                    r = (a.y || 0) + (b.y || 0),
                ...
                g && (e += (a.width - (b.width || 0)) / g);
                "bottom" === d ? f = 1 : "middle" === d && (f = 2);
                f && (r += (a.height - (b.height || 0)) / f);
                return {
                    x: Math.round(e),
                    y: Math.round(r)
                }
            ...
            a.justifiedOptions = function(b, a, c, d) {
                ...
                d = (d.y || 0) - b.plotTop;
                var h = c + f;
                0 > h && ("right" === e ? a.align = "left" : a.x = (a.x || 0) - h);
                h = c + r.width - f;
                h > b.plotWidth && ("left" === e ? a.align = "right" : a.x = (a.x || 0) + b.plotWidth - h);
                h = d + f;
                0 > h && ("bottom" === g ? a.verticalAlign = "top" : a.y = (a.y || 0) - h);
                h = d + r.height - f;
                h > b.plotHeight && ("top" === g ? a.verticalAlign = "bottom" : a.y = (a.y ||
                    0) + b.plotHeight - h);
                return a
            };
            a.prototype.translatePoint = function(a, b) {
                c.translatePoint.call(this, a, b, 0)
            };
            a.prototype.translate = function(a, b) {
                var c = this.annotation.chart,
                    d = this.annotation.userOptions,
                    e = c.annotations.indexOf(this.annotation);
                e = c.options.annotations[e];
                ...
                d[this.collection][this.index].y =
                    this.options.y
            };
            a.prototype.render = function(b) {
                var d = this.options,
                    ...
                    g = d.style;
                this.graphic = this.annotation.chart.renderer.label("", 0, -9999, d.shape, null, null, d.useHTML, null, "annotation-label").attr(e).add(b);
                this.annotation.chart.styledMode || ("contrast" === g.color && (g.color = this.annotation.chart.renderer.getContrast(-1 < a.shapesWithoutBackground.indexOf(d.shape) ? "#FFFFFF" : d.backgroundColor)), this.graphic.css(d.style).shadow(d.shadow));
            ...
            a.prototype.redraw = function(a) {
                var d = this.options,
                    e = this.text || d.format || d.text,
                    g = this.graphic,
                    f = this.points[0];
                g.attr({
                    text: e ? b(e, f.getLabelConfig(), this.annotation.chart) : d.formatter.call(f, this)
                });
                d = this.anchor(f);
                (e = this.position(d)) ? (g.alignAttr = e, e.anchorX = d.absolutePosition.x, e.anchorY = d.absolutePosition.y, g[a ? "animate" : "attr"](e)) : g.attr({
                    x: 0,
                    y: -9999
                });
                g.placed = !!e;
            ...
            a.prototype.anchor = function(a) {
                var b = c.anchor.apply(this,
                        arguments),
                    d = this.options.x || 0,
                    e = this.options.y || 0;
                b.absolutePosition.x -= d;
                b.absolutePosition.y -= e;
                b.relativePosition.x -= d;
            ...
            a.prototype.position = function(b) {
                var c = this.graphic,
                    ...
                    g = this.points[0],
                    n = this.options,
                    u = b.absolutePosition,
                    t = b.relativePosition,
                    A = g.series.visible && p.prototype.isInsidePlot.call(g);
                b = c.width;
                b = void 0 === b ? 0 : b;
                var h = c.height;
                h = void 0 === h ? 0 : h;
                if (A) {
                    ...
                    else n.positioner ? l = n.positioner.call(this) : (g = {
                        x: u.x,
                        y: u.y,
                        width: 0,
                        height: 0
                    }, l = a.alignedPosition(f(n, {
                        width: b,
                        height: h
                    }), g), "justify" === this.options.overflow && (l = a.alignedPosition(a.justifiedOptions(d, c, n, l), g)));
                    n.crop && (c = l.x - d.plotLeft, n = l.y - d.plotTop, A = d.isInsidePlot(c, n) && d.isInsidePlot(c + b, n + h))
                }
                return A ? l : null
            };
            a.attrsMap = {
        ...
        a.connector = function(b, a, c, e, f) {
            var g = f && f.anchorX;
            f = f && f.anchorY;
            var n = c / 2;
            if (d(g) && d(f)) {
                ...
                0 > p && (p = -e - p);
                p < c && (n = g < b + c / 2 ? p : c - p);
                f > a + e ? m.push(["L", b + n, a + e]) : f < a ? m.push(["L", b + n, a]) : g < b ? m.push(["L", b, a + e / 2]) : g > b + c && m.push(["L", b + c, a + e / 2])
            }
            return m || []
        };
        return n
    ...
    x(a, "Extensions/Annotations/Controllables/ControllableImage.js", [a["Extensions/Annotations/Controllables/ControllableLabel.js"],
        a["Extensions/Annotations/Mixins/ControllableMixin.js"]
    ], function(a, f) {
        return function() {
            function c(a, c, n) {
            ...
            c.prototype.render = function(a) {
                var c = this.attrsFromOptions(this.options),
                    n = this.options;
                this.graphic = this.annotation.chart.renderer.image(n.src, 0, -9E9, n.width, n.height).attr(c).add(a);
                this.graphic.width = n.width;
                this.graphic.height = n.height;
                f.render.call(this)
            };
            c.prototype.redraw =
                function(c) {
                    var m = this.anchor(this.points[0]);
                    if (m = a.prototype.position.call(this, m)) this.graphic[c ? "animate" : "attr"]({
                        x: m.x,
                        y: m.y
                    });
                    else this.graphic.attr({
    ...
    x(a, "Extensions/Annotations/Annotations.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Chart/Chart.js"], a["Extensions/Annotations/Mixins/ControllableMixin.js"], a["Extensions/Annotations/Controllables/ControllableRect.js"],
        ...
        var y = function() {
            function a(a, b) {
                ...
                this.labels = [];
                this.shapes = [];
                this.options = k(this.defaultOptions, b);
                this.userOptions = b;
            ...
            a.prototype.setOptions = function(a) {
                this.options = k(this.defaultOptions, a)
            };
            a.prototype.redraw = function(a) {
                this.linkPoints();
            ...
            a.prototype.redrawItems = function(a,
                b) {
            ...
            a.prototype.setVisibility = function(a) {
                ...
                a || (this.setControlPointsVisibility(!1), c.activeAnnotation === this && c.popup && "annotation-toolbar" === c.popup.formType && z(c, "closePopup"));
                b.visible = a
            };
            ...
            a.prototype.destroy = function() {
                ...
                h(a.labelCollectors, this.labelCollector);
                e.destroy.call(this);
                p.destroy.call(this);
                A(this, a)
            };
            ...
            a.prototype.update = function(a,
                ...
                var c = this.chart,
                    ...
                    H = c.annotations.indexOf(this);
                a = k(!0, this.userOptions, a);
                a.labels = d.labels;
                a.shapes = d.shapes;
                this.destroy();
                this.constructor(c, a);
                c.options.annotations[H] = a;
                this.isUpdating = !0;
                v(b, !0) && c.redraw();
                z(this, "afterUpdate");
                this.isUpdating = !1
            ...
            a.prototype.redrawItem = function(a, b) {
                a.linkPoints();
                a.shouldBeDrawn() ? (a.graphic || this.renderItem(a), a.redraw(v(b, !0) && a.graphic.placed), a.points.length && this.adjustVisibility(a)) : this.destroyItem(a)
            };
        ...
        t.extendAnnotation = function(a, b, c, d) {
            b = b || y;
            l(a.prototype, k(b.prototype, c));
            a.prototype.defaultOptions = k(a.prototype.defaultOptions, d || {})
        };
        l(a, {
            initAnnotation: function(a) {
                a = new(y.types[a.type] || y)(this, a);
            ...
            removeAnnotation: function(a) {
                var b = this.annotations,
                    c = "annotations" === a.coll ? a : w(b, function(b) {
                        return b.options.id === a
                    });
                c && (z(c, "remove"), h(this.options.annotations, c.options), h(b, c), c.destroy())
            },
        ...
        a.callbacks.push(function(a) {
            ...
            a.options.annotations.forEach(function(b, c) {
                if (!a.annotations.some(function(a) {
                        return a.options === b
                    })) {
                    var d = a.initAnnotation(b);
                    a.options.annotations[c] = d.options
                }
            });
            a.drawAnnotations();
            ...
            C(a, "exportData", function(b) {
                var c = (this.options.exporting && this.options.exporting.csv || {}).columnHeaderFormatter,
                    d = !b.dataRows[1].xValues,
                    k = a.options.lang && a.options.lang.exportData && a.options.lang.exportData.annotationHeader,
                    v = function(a) {
                        if (c) {
                            var b = c(a);
                            if (!1 !== b) return b
                    ...
                    G = a.options.exporting && a.options.exporting.csv && a.options.exporting.csv.annotations && a.options.exporting.csv.annotations.join;
                        ...
                        if (a.options.text) {
                            ...
                            a.points.forEach(function(a) {
                                ...
                                if (-1 === k) {
                                    ...
                                    for (var y = Array(a), l = 0; l < a; ++l) y[l] = "";
                                    y.push(c);
                                    y.xValues = [];
                                    y.xValues[k] = d;
                                    b.dataRows.push(y);
                                ...
                                v ||
                                    b.dataRows.forEach(function(a, b) {
                                        !v && a.xValues && void 0 !== k && d === a.xValues[k] && (G && a.length > h ? a[a.length - 1] += e + c : a.push(c), v = !0)
                                    });
                                if (!v) {
                                    a = b.dataRows[0].length;
                                    y = Array(a);
                ...
                b.dataRows.forEach(function(a) {
                    y = Math.max(y, a.length)
                });
                for (var l = y - b.dataRows[0].length, f = 0; f < l; f++) {
                    var g = v(f + 1);
                    d ? (b.dataRows[0].push(g.topLevelColumnTitle), b.dataRows[1].push(g.columnTitle)) : b.dataRows[0].push(g)
                }
            })
        });
        q(r.prototype, "onContainerMouseDown", function(a) {
    ...
    x(a, "Mixins/Navigation.js", [], function() {
        return {
                ...
                a.navigation || (a.navigation = {
                    ...
                    update: function(a, c) {
                        this.updates.forEach(function(f) {
                            f.update.call(f.context, a, c)
                        })
                    }
                })
            },
            addUpdate: function(a, f) {
    ...
    x(a, "Extensions/Annotations/NavigationBindings.js", [a["Extensions/Annotations/Annotations.js"], a["Core/Chart/Chart.js"], a["Mixins/Navigation.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/DefaultOptions.js"], a["Core/Utilities.js"]], function(a, f, p, u, m, n, b) {
        function c(a, b) {
            var c = w.Element.prototype,
        ...
        function d(a) {
            ...
            D(!0, a.prototype.defaultOptions.events, {
                click: function(a) {
                    ...
                    b && b.call(c, a);
                    k !== c ? (d.deselectAnnotation(), d.activeAnnotation = c, c.setControlPointsVisibility(!0), r(d, "showPopup", {
                        annotation: c,
                        formType: "annotation-toolbar",
                        options: d.annotationToFields(c),
                        onSubmit: function(a) {
                            var b = {};
                            "remove" === a.actionType ? (d.activeAnnotation = !1, d.chart.removeAnnotation(c)) : (d.fieldsToOptions(a.fields, b), d.deselectAnnotation(),
            ...
            z = function() {
                ...
                a.prototype.initEvents = function() {
                    ...
                    [].forEach.call(c, function(b) {
                        a.eventsToUnbind.push(t(b, "click", function(c) {
                    ...
                    a.eventsToUnbind.push(t(b.container, "click", function(c) {
                        !b.cancelClick && b.isInsidePlot(c.chartX - b.plotLeft, c.chartY - b.plotTop, {
                            visiblePlotOnly: !0
                        }) && a.bindingsChartClick(this, c)
                    }));
                    a.eventsToUnbind.push(t(b.container, m.isTouchDevice ? "touchmove" : "mousemove", function(b) {
                ...
                a.prototype.bindingsButtonClick = function(a,
                    b, c) {
                    var d = this.chart;
                    this.selectedButtonElement && (r(this, "deselectButton", {
                ...
                a.prototype.bindingsChartClick =
                    function(a, b) {
                        a = this.chart;
                        var d = this.activeAnnotation,
                            h = this.selectedButton;
                        a = a.renderer.boxWrapper;
                        d && (d.cancelClick || b.activeAnnotation || !b.target.parentNode || c(b.target, ".highcharts-popup") ? d.cancelClick && setTimeout(function() {
                            d.cancelClick = !1
                        }, 0) : r(this, "closePopup"));
                        h && h.start && (this.nextEvent ? (this.nextEvent(b, this.currentUserDetails), this.steps && (this.stepIndex++, h.steps[this.stepIndex] ? this.mouseMoveEvent = this.nextEvent = h.steps[this.stepIndex] : (r(this, "deselectButton", {
                                button: this.selectedButtonElement
                            }),
                            a.removeClass("highcharts-draw-mode"), h.end && h.end.call(this, b, this.currentUserDetails), this.mouseMoveEvent = this.nextEvent = !1, this.selectedButton = null))) : (this.currentUserDetails = h.start.call(this, b)) && h.steps ? (this.stepIndex = 0, this.steps = !0, this.mouseMoveEvent = this.nextEvent = h.steps[this.stepIndex]) : (r(this, "deselectButton", {
                            button: this.selectedButtonElement
                        }), a.removeClass("highcharts-draw-mode"), this.steps = !1, this.selectedButton = null, h.end && h.end.call(this, b, this.currentUserDetails)))
                    };
                ...
                a.prototype.fieldsToOptions = function(a, b) {
                    A(a, function(a, c) {
                        ...
                        "" !== a && "undefined" !== a && e.forEach(function(b, c) {
                            var d = h(e[c + 1], "");
                            l === c ? k[b] = a : (k[b] || (k[b] = d.match(/\d/g) ? [] : {}), k = k[b])
                        })
                    });
                    return b
                };
                ...
                a.prototype.annotationToFields = function(b) {
                    function c(a, d, h, k) {
                        if (h && a && -1 === g.indexOf(d) && (0 <= (h.indexOf && h.indexOf(d)) || h[d] || !0 === h))
                            if (q(a)) k[d] = [], a.forEach(function(a, b) {
                                C(a) ? (k[d][b] = {}, A(a, function(a, h) {
                                    c(a, h, l[d], k[d][b])
                                })) : c(a, 0, l[d], k[d])
                            });
                            else if (C(a)) {
                            var v = {};
                            q(k) ? (k.push(v), v[d] = {}, v = v[d]) : k[d] = v;
                            A(a, function(a, b) {
                                c(a, b, 0 === d ? h : l[d], v)
                            })
                        } else "format" === d ? k[d] = [e(a, b.labels[0].points[0]).toString(), "text"] : q(k) ? k.push([a, f(a)]) : k[d] = [a, f(a)]
                    }
                    var d = b.options,
                        k = a.annotationsEditable,
                        l = k.nestedOptions,
                        f = this.utils.getFieldType,
                        v = h(d.type, d.shapes && d.shapes[0] && d.shapes[0].type, d.labels && d.labels[0] && d.labels[0].itemType, "label"),
                        g = a.annotationsNonEditable[d.langKey] || [],
                        w = {
                            langKey: d.langKey,
                            type: v
                        };
                    A(d, function(a, b) {
                        "typeOptions" === b ? (w[b] = {}, A(d[b], function(a, d) {
                            c(a, d, l, w[b], !0)
                        })) : c(a, b, k[v], w)
                    });
                    return w
                ...
                a.prototype.getClickedClassNames = function(a, b) {
                    var c = b.target;
                    b = [];
                    for (var d; c && ((d = g(c, "class")) && (b = b.concat(d.split(" ").map(function(a) {
                            return [a,
                                c
                            ]
                        }))), c = c.parentNode, c !== a););
        ...
        z.prototype.utils = {
            ...
            updateRectSize: function(a, b) {
                var c = b.chart,
                    ...
                    h = B(d.xAxis) && c.xAxis[d.xAxis],
                    k = B(d.yAxis) && c.yAxis[d.yAxis];
                h && k && (h = h.toValue(a[h.horiz ? "chartX" : "chartY"]), a = k.toValue(a[k.horiz ? "chartX" : "chartY"]), k = h - d.point.x, d = d.point.y - a, b.update({
                    typeOptions: {
                        background: {
                            width: c.inverted ? d : k,
                            height: c.inverted ? k : d
                        }
                    }
                }))
            },
            getAssignedAxis: function(a) {
                return a.filter(function(a) {
                    var b = a.axis.min,
                        c = a.axis.max,
                        d = h(a.axis.minPointOffset, 0);
                    return B(b) && B(c) && a.value >= b - d && a.value <= c + d && !a.axis.options.isInternal
                })[0]
            }
        };
                ...
                bindings: {
                    circleAnnotation: {
                        ...
                        start: function(a) {
                            ...
                            if (a && b) return this.chart.addAnnotation(D({
                                langKey: "circle",
                        ...
                        steps: [function(a, b) {
                            ...
                            if (B(c.xAxis) && B(c.yAxis)) {
                                var h = this.chart.xAxis[c.xAxis].toPixels(c.x);
                                c = this.chart.yAxis[c.yAxis].toPixels(c.y);
                                h = Math.max(Math.sqrt(Math.pow(d ? c - a.chartX : h - a.chartX, 2) + Math.pow(d ? h - a.chartY : c - a.chartY, 2)), 5)
                            }
                            b.update({
                                shapes: [{
                                    r: h
                    ...
                    rectangleAnnotation: {
                        ...
                        start: function(a) {
                            ...
                            if (b && c) {
                                ...
                                return this.chart.addAnnotation(D({
                                    langKey: "rectangle",
                                    type: "basicAnnotation",
                                    shapes: [{
                                        type: "path",
                        ...
                        steps: [function(a, b) {
                            ...
                            a && d && (a = a.value, d = d.value, c[1].x = a, c[2].x = a, c[2].y = d, c[3].y = d, b.update({
                                shapes: [{
                                    points: c
                                }]
                            }))
                    ...
                    labelAnnotation: {
                        ...
                        start: function(a) {
                            ...
                            var c = this.chart.options.navigation;
                            if (a &&
                                b) return this.chart.addAnnotation(D({
                                langKey: "label",
                                type: "basicAnnotation",
                                labelOptions: {
                                    format: "{y:.2f}"
                    ...
                    function(b, d) {
                        if (a.navigationBindings && a.navigationBindings.container && a.navigationBindings.container[0] && (d = a.navigationBindings.container[0].querySelectorAll("." + d)))
                            for (var h = 0; h < d.length; h++) {
                                var e = d[h];
                                "normal" === b.noDataState ? -1 !== e.className.indexOf("highcharts-disabled-btn") && e.classList.remove("highcharts-disabled-btn") : c ? -1 !== e.className.indexOf("highcharts-disabled-btn") && e.classList.remove("highcharts-disabled-btn") : -1 === e.className.indexOf("highcharts-disabled-btn") && (e.className += " highcharts-disabled-btn")
                            }
                    })
            }
        });
        t(z, "closePopup", function() {
    ...
    x(a, "Extensions/Annotations/Popup.js", [a["Core/Globals.js"], a["Extensions/Annotations/NavigationBindings.js"], a["Core/DefaultOptions.js"], a["Core/Pointer.js"], a["Core/Utilities.js"]], function(a, f, p, u, m) {
        ...
        p = m.wrap;
        var A = /\d/g;
        p(u.prototype, "onContainerMouseDown",
            function(a, b) {
                var c = b.target && b.target.className;
                E(c) && 0 <= c.indexOf("highcharts-popup-field") || a.apply(this, Array.prototype.slice.call(arguments, 1))
            });
        a.Popup = function(a, b, c) {
            this.init(a, b, c)
        };
        a.Popup.prototype = {
            init: function(a, b, c) {
            ...
            addCloseBtn: function() {
                ...
                var c = e("div", {
                    ...
                    this.container);
                c.style["background-image"] = "url(" + (b.match(/png|svg|jpeg|jpg|gif/ig) ? b : b + "close.svg") + ")";
                ["click", "touchstart"].forEach(function(b) {
                    d(c, b, function() {
                        a.chart ? g(a.chart.navigationBindings, "closePopup") : a.closePopup()
                    })
                })
            },
            ...
            addInput: function(a, b, d, f) {
                ...
                b.match(A) || e("label", {
                    htmlFor: b
                }, void 0, d).appendChild(c.createTextNode(l[h] || h));
                "" !== f && e("input", {
                    name: b,
                    value: f[0],
                    type: f[1],
                    className: "highcharts-popup-field"
                }, void 0, d).setAttribute("highcharts-data-name", a)
            },
            addButton: function(a, b, f, g, k) {
                var h = this,
                    l = this.closePopup,
                    w = this.getFields;
                var z = e("button", void 0, void 0, a);
                z.appendChild(c.createTextNode(b));
            ...
            getFields: function(a, b) {
                ...
                [].forEach.call(c, function(a) {
                    ...
                    (h = a.getAttribute("highcharts-data-series-id")) ? f.seriesId = a.value: e ? f.fields[e] = a.value : f.type = a.value
                });
                a && (f.fields["params.volumeSeriesID"] =
            ...
            annotations: {
                addToolbar: function(a, b, d) {
                    ...
                    a && (g.style.top = a.plotTop + 10 + "px");
                    e("span", void 0, void 0, g).appendChild(c.createTextNode(C(f[b.langKey] || b.langKey, b.shapes && b.shapes[0].type)));
                    var w = this.addButton(g, f.removeButton || "remove", "remove", d, g);
                    w.className += " highcharts-annotation-remove-button";
                    w.style["background-image"] = "url(" + this.iconsURL + "destroy.svg)";
                    w = this.addButton(g, f.editButton || "edit", "edit", function() {
                        l.call(h, "annotation-edit",
                            a, b, d)
                    }, g);
                    w.className += " highcharts-annotation-edit-button";
                    w.style["background-image"] = "url(" + this.iconsURL + "edit.svg)"
                },
                addForm: function(a, b, d, f) {
                    var h = this.popup.container,
                        g = this.lang;
                    if (a) {
                        var l = e("h2", {
                            className: "highcharts-popup-main-title"
                        }, void 0, h);
                        l.appendChild(c.createTextNode(g[b.langKey] || b.langKey || ""));
                        l = e("div", {
                        ...
                        this.annotations.addFormFields.call(this,
                            l, a, "", b, [], !0);
                        this.addButton(w, f ? g.addButton || "add" : g.saveButton || "save", f ? "add" : "save", d, h)
                    }
                },
                addFormFields: function(a, d, f, g, k, m) {
                    ...
                    d && (B(g, function(b, c) {
                        z = "" !== f ? f + "." + c : c;
                        q(b) && (!r(b) || r(b) && q(b[0]) ? (v = n[c] || c, v.match(A) || k.push([!0, v, a]), l.call(h, a, d, z, b, k, !1)) : k.push([h, z, "annotation", a, b]))
                    }), m && (D(k, function(a) {
                        return a[1].match(/format/g) ? -1 : 1
                    }), b && k.reverse(), k.forEach(function(a) {
                        !0 === a[0] ? e("span", {
            ...
            indicators: {
                addForm: function(a, b, c) {
                    ...
                    if (a) {
                        ...
                        var h = b[0].querySelectorAll(".highcharts-popup-rhs-col")[0];
                        this.addButton(h, e.addButton || "add", "add", c, h);
                        this.addColsContainer(b[1]);
                        d.addIndicatorList.call(this, a, b[1], "edit");
                        h = b[1].querySelectorAll(".highcharts-popup-rhs-col")[0];
                        this.addButton(h, e.saveButton || "save", "edit", c, h);
                        this.addButton(h, e.removeButton || "remove", "remove", c, h)
                    }
                },
                addIndicatorList: function(a, b, f) {
                    var h = this,
                        g = b.querySelectorAll(".highcharts-popup-lhs-col")[0];
                    b = b.querySelectorAll(".highcharts-popup-rhs-col")[0];
                    var l = "edit" === f,
                        w = l ? a.series : a.options.plotOptions,
                    ...
                    if (a) {
                        ...
                        B(w, function(b, f) {
                            var g = b.options;
                            if (b.params || g && g.params) {
                                var k = h.indicators.getNameType(b, f),
                                    z = k.type;
                                n = e("li", {
                                    className: "highcharts-indicator-list"
                                }, void 0, p);
                                n.appendChild(c.createTextNode(k.name));
                                ["click", "touchstart"].forEach(function(c) {
                                    d(n, c, function() {
                                        m.call(h, a, l ? b : w[z], k.type, q);
                                        l && b.options && e("input", {
                                            type: "hidden",
                                            name: "highcharts-id-" + z,
                                            value: b.options.id
                ...
                listAllSeries: function(a, b, d, f, g) {
                    ...
                    if (d) {
                        e("label", {
                            htmlFor: a
                        }, null, f).appendChild(c.createTextNode(h[b] || b));
                        var k = e("select", {
                            name: a,
                            className: "highcharts-popup-field"
                        }, null, f);
                        ...
                        d.series.forEach(function(a) {
                            l = a.options;
                            !l.params && l.id && "highcharts-navigator-series" !==
                                l.id && e("option", {
                                    value: l.id
                                }, null, k).appendChild(c.createTextNode(l.name || l.id))
                        });
                        t(g) && (k.value = g)
                    }
                },
                addFormFields: function(a, b, d, f) {
                    ...
                    }, void 0, f).appendChild(c.createTextNode(g(b, d).name));
                    e("input", {
                        type: "hidden",
                        name: "highcharts-type-" + d,
                        value: d
                    }, null, f);
                    this.indicators.listAllSeries.call(this, d, "series", a, f, b.linkedParent && h.volumeSeriesID);
                    h.volumeSeriesID && this.indicators.listAllSeries.call(this,
                        d, "volume", a, f, b.linkedParent && b.linkedParent.options.id);
                    this.indicators.addParamInputs.call(this, a, "params", h, d, f)
                },
                addParamInputs: function(a, b, c, d, e) {
                    ...
                    a && B(c, function(c, k) {
                        l = b + "." + k;
                        void 0 !== c && (q(c) ? (g.call(f, l, d, e, ""), h.call(f, a, l, c, d, e)) : "params.volumeSeriesID" !== l && g.call(f, l, d, e, [c, "text"]))
                    })
                },
                getAmount: function() {
                    var a = 0;
            ...
            tabs: {
                ...
                addMenuItem: function(a, b) {
                    var d = this.popup.container,
                        f = "highcharts-tab-item",
                        g = this.lang;
                    0 === b && (f += " highcharts-tab-disabled");
                    b = e("span", {
                        className: f
                    }, void 0, d);
                    b.appendChild(c.createTextNode(g[a + "Button"] || a));
        ...
        d(f, "showPopup", function(b) {
            this.popup || (this.popup = new a.Popup(this.chart.container, this.chart.options.navigation.iconsURL || this.chart.options.stockTools &&
                this.chart.options.stockTools.gui.iconsURL || "https://code.highcharts.com/9.2.2/gfx/stock-icons/", this.chart));
            this.popup.showForm(b.formType, this.chart, b.options, b.onSubmit)
        });
        d(f, "closePopup", function() {
